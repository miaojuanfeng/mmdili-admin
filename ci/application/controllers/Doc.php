...
class Doc extends CI_Controller {
    ...
    public function index($pn = 1){
		...
		*/
		...
		$cii_pagination['full_tag_open'] = '<div class="pn"><div class="pn-container">';
		$cii_pagination['full_tag_close'] = '<div class="clearfix"></div></div><div class="clearfix"></div></div>';
		$cii_pagination['first_tag_open'] = '<span>';
		$cii_pagination['first_tag_close'] = '</span>';
		$cii_pagination['last_tag_open'] = '<span>';
		$cii_pagination['last_tag_close'] = '</span>';
		$cii_pagination['next_tag_open'] = '<span>';
		$cii_pagination['next_tag_close'] = '</span>';
		$cii_pagination['prev_tag_open'] = '<span>';
		$cii_pagination['prev_tag_close'] = '</span>';
		$cii_pagination['cur_tag_open'] = '<span class="current">';
		$cii_pagination['cur_tag_close'] = '</span>';
		$cii_pagination['num_tag_open'] = '<span>';
		$cii_pagination['num_tag_close'] = '</span>';
		$cii_pagination['use_page_numbers'] = true;
